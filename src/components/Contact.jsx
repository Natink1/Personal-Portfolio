...
export default function Contact() {
  ...
  const socialLinks = [
    { name: "GitHub", href: "https://github.com/Natink1", icon: Github },
    { name: "LinkedIn", href: "https://www.linkedin.com/in/natnael-deribe/", icon: Linkedin },
  ];
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-[1fr_1.4fr]">
          <div className="space-y-4">
            {[
              ...
              <div
                key={label}
                className="glass-card glow-on-hover flex items-center gap-4 rounded-2xl p-5"
              >
